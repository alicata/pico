# 3. Adding Walls to Stop Pico

"""
1. Add a blue wall 
2. Check if Pico touches the wall. 
3. If Pico touches wall, stop him from moving past it.
"""
...
while running:
    ...
    pygame.draw.rect(screen, wall_color, (wall_x, wall_y, wall_width, wall_height))  # Draw the wall
    pygame.display.flip()
