# Step 4: Making Pico Jump

"""
Gravity added: 
    A downward force is applied (through increasing pico_y_velocity) to make Pico fall back down after jumping.
Jump triggered with space bar: 
    When the space bar is pressed, Pico’s y_velocity is set to a negative value, making him move up.
Falling back down: 
    Gravity constantly increases pico_y_velocity until Pico lands on the ground.
Stops at ground: 
    When Pico reaches the ground (y-coordinate 500), the jump ends, and Pico stops falling.
"""
